...
class CustomerModel
{
    ...
    public function saveCustomer($name, $lastname,$email,$balance)
    {
        try
        {
            $sql =  'INSERT INTO usuarios (nombres,apellidos,correo_electronico,saldo)';
            $sql .= ' VALUES (:name, :lastname, :email, :balance)';
